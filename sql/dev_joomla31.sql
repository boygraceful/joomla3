...
--
-- Host: localhost
-- Generation Time: Jun 07, 2013 at 04:50 PM
...
--
-- Database: `dev_joomla31`
--

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_assets`
--

DROP TABLE IF EXISTS `ne13y_assets`;
CREATE TABLE IF NOT EXISTS `ne13y_assets` (
...
--
-- Dumping data for table `ne13y_assets`
--

INSERT INTO `ne13y_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `ne13y_associations`
--

DROP TABLE IF EXISTS `ne13y_associations`;
CREATE TABLE IF NOT EXISTS `ne13y_associations` (
...
--
-- Table structure for table `ne13y_banners`
--

DROP TABLE IF EXISTS `ne13y_banners`;
CREATE TABLE IF NOT EXISTS `ne13y_banners` (
...
--
-- Table structure for table `ne13y_banner_clients`
--

DROP TABLE IF EXISTS `ne13y_banner_clients`;
CREATE TABLE IF NOT EXISTS `ne13y_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `ne13y_banner_tracks`
--

DROP TABLE IF EXISTS `ne13y_banner_tracks`;
CREATE TABLE IF NOT EXISTS `ne13y_banner_tracks` (
...
--
-- Table structure for table `ne13y_categories`
--

DROP TABLE IF EXISTS `ne13y_categories`;
CREATE TABLE IF NOT EXISTS `ne13y_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ne13y_categories`
--

INSERT INTO `ne13y_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 907, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_contact_details`
--

DROP TABLE IF EXISTS `ne13y_contact_details`;
CREATE TABLE IF NOT EXISTS `ne13y_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `ne13y_content`
--

DROP TABLE IF EXISTS `ne13y_content`;
CREATE TABLE IF NOT EXISTS `ne13y_content` (
...
--
-- Table structure for table `ne13y_content_frontpage`
--

DROP TABLE IF EXISTS `ne13y_content_frontpage`;
CREATE TABLE IF NOT EXISTS `ne13y_content_frontpage` (
...
--
-- Table structure for table `ne13y_content_rating`
--

DROP TABLE IF EXISTS `ne13y_content_rating`;
CREATE TABLE IF NOT EXISTS `ne13y_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ne13y_content_types`
--

DROP TABLE IF EXISTS `ne13y_content_types`;
CREATE TABLE IF NOT EXISTS `ne13y_content_types` (
...
--
-- Dumping data for table `ne13y_content_types`
--

INSERT INTO `ne13y_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`) VALUES
...
--
-- Table structure for table `ne13y_core_log_searches`
--

DROP TABLE IF EXISTS `ne13y_core_log_searches`;
CREATE TABLE IF NOT EXISTS `ne13y_core_log_searches` (
...
--
-- Table structure for table `ne13y_extensions`
--

DROP TABLE IF EXISTS `ne13y_extensions`;
CREATE TABLE IF NOT EXISTS `ne13y_extensions` (
...
--
-- Dumping data for table `ne13y_extensions`
--

INSERT INTO `ne13y_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10000, 'zo2_base', 'template', 'zo2_base', '', 0, 1, 1, 0, '{"name":"zo2_base","type":"template","creationDate":"May 2013","author":"JoomVision.com","copyright":"Copyright (C) 2010 - 2013 JoomVision.com. All rights reserved.","authorEmail":"support@joomvision.com","authorUrl":"http:\\/\\/www.joomvision.com","version":"1.0.2","description":"\\n\\t\\t\\n\\t\\t\\t<!-- content goes here -->\\n\\t\\t\\n\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Zo2 Framework', 'plugin', 'zo2', 'system', 0, 1, 1, 0, '{"name":"Zo2 Framework","type":"plugin","creationDate":"May 2013","author":"JoomVision","copyright":"Copyright (C) 2010 - 2013 JoomVision. All rights reserved.","authorEmail":"support@joomvision.com","authorUrl":"www.joomvision.com","version":"0.0.1","description":"Zo2 Framework - Template Framework for Joomla 3","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_finder_filters`
--

DROP TABLE IF EXISTS `ne13y_finder_filters`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_filters` (
...
--
-- Table structure for table `ne13y_finder_links`
--

DROP TABLE IF EXISTS `ne13y_finder_links`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links` (
...
--
-- Table structure for table `ne13y_finder_links_terms0`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms0` (
...
--
-- Table structure for table `ne13y_finder_links_terms1`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms2`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms3`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms4`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms5`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms6`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms7`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms8`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_terms9`
--

DROP TABLE IF EXISTS `ne13y_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termsa`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termsb`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termsc`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termsd`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termse`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_links_termsf`
--

DROP TABLE IF EXISTS `ne13y_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `ne13y_finder_taxonomy`
--

DROP TABLE IF EXISTS `ne13y_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `ne13y_finder_taxonomy`
--

INSERT INTO `ne13y_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `ne13y_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ne13y_finder_terms`
--

DROP TABLE IF EXISTS `ne13y_finder_terms`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_terms` (
...
--
-- Table structure for table `ne13y_finder_terms_common`
--

DROP TABLE IF EXISTS `ne13y_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `ne13y_finder_terms_common`
--

INSERT INTO `ne13y_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `ne13y_finder_tokens`
--

DROP TABLE IF EXISTS `ne13y_finder_tokens`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ne13y_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `ne13y_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ne13y_finder_types`
--

DROP TABLE IF EXISTS `ne13y_finder_types`;
CREATE TABLE IF NOT EXISTS `ne13y_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `ne13y_languages`
--

DROP TABLE IF EXISTS `ne13y_languages`;
CREATE TABLE IF NOT EXISTS `ne13y_languages` (
...
--
-- Dumping data for table `ne13y_languages`
--

INSERT INTO `ne13y_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_menu`
--

DROP TABLE IF EXISTS `ne13y_menu`;
CREATE TABLE IF NOT EXISTS `ne13y_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ne13y_menu`
--

INSERT INTO `ne13y_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(465, 'menu', 'com_tags', 'com-tags', '', 'com-tags', 'index.php?option=com_tags', 'component', 0, 1, 1, 29, 0, '0000-00-00 00:00:00', 0, 1, 'class:tags', 0, '', 223, 224, 0, '', 1),
(466, 'mainmenu', 'menu td', 'menu-td', '', 'homepage/menu-td', 'index.php?option=com_content&view=article&id=1', 'component', 0, 435, 2, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_tags":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 2, 3, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_menu_types`
--

DROP TABLE IF EXISTS `ne13y_menu_types`;
CREATE TABLE IF NOT EXISTS `ne13y_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ne13y_menu_types`
--

INSERT INTO `ne13y_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `ne13y_messages`
--

DROP TABLE IF EXISTS `ne13y_messages`;
CREATE TABLE IF NOT EXISTS `ne13y_messages` (
...
--
-- Table structure for table `ne13y_messages_cfg`
--

DROP TABLE IF EXISTS `ne13y_messages_cfg`;
CREATE TABLE IF NOT EXISTS `ne13y_messages_cfg` (
...
--
-- Table structure for table `ne13y_modules`
--

DROP TABLE IF EXISTS `ne13y_modules`;
CREATE TABLE IF NOT EXISTS `ne13y_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ne13y_modules`
--

INSERT INTO `ne13y_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'top', 907, '2013-05-31 09:12:30', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":" nav-pills","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"1","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
--
-- Table structure for table `ne13y_modules_menu`
--

DROP TABLE IF EXISTS `ne13y_modules_menu`;
CREATE TABLE IF NOT EXISTS `ne13y_modules_menu` (
...
--
-- Dumping data for table `ne13y_modules_menu`
--

INSERT INTO `ne13y_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `ne13y_newsfeeds`
--

DROP TABLE IF EXISTS `ne13y_newsfeeds`;
CREATE TABLE IF NOT EXISTS `ne13y_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `ne13y_overrider`
--

DROP TABLE IF EXISTS `ne13y_overrider`;
CREATE TABLE IF NOT EXISTS `ne13y_overrider` (
...
--
-- Table structure for table `ne13y_redirect_links`
--

DROP TABLE IF EXISTS `ne13y_redirect_links`;
CREATE TABLE IF NOT EXISTS `ne13y_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `ne13y_schemas`
--

DROP TABLE IF EXISTS `ne13y_schemas`;
CREATE TABLE IF NOT EXISTS `ne13y_schemas` (
...
--
-- Dumping data for table `ne13y_schemas`
--

INSERT INTO `ne13y_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.1.1');

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_session`
--

DROP TABLE IF EXISTS `ne13y_session`;
CREATE TABLE IF NOT EXISTS `ne13y_session` (
...
--
-- Dumping data for table `ne13y_session`
--

INSERT INTO `ne13y_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('inp37um87hc1pb6f6in6qn3382', 1, 0, '1370597960', '__default|a:8:{s:15:"session.counter";i:54;s:19:"session.timer.start";i:1370589345;s:18:"session.timer.last";i:1370597118;s:17:"session.timer.now";i:1370597959;s:22:"session.client.browser";s:107:"Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1496.0 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:13:"com_templates";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:3:{i:0;i:7;i:1;i:8;i:2;i:9;}s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"907";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:19:"admin@localhost.com";s:8:"password";s:65:"c0ea81636fa2628bd6a805d4cede9dad:juuuMndoI9ujpsQVYJwsEeL71AbrkzZu";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-05-28 01:42:34";s:13:"lastvisitDate";s:19:"2013-06-03 07:41:09";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"ebd4a6df01cc29fdc7484847f2a5f69a";}', 907, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_tags`
--

DROP TABLE IF EXISTS `ne13y_tags`;
CREATE TABLE IF NOT EXISTS `ne13y_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `ne13y_tags`
--

INSERT INTO `ne13y_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_template_styles`
--

DROP TABLE IF EXISTS `ne13y_template_styles`;
CREATE TABLE IF NOT EXISTS `ne13y_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ne13y_template_styles`
--

INSERT INTO `ne13y_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'zo2_base', 0, '1', 'zo2_base - Default', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_ucm_base`
--

DROP TABLE IF EXISTS `ne13y_ucm_base`;
CREATE TABLE IF NOT EXISTS `ne13y_ucm_base` (
...
--
-- Table structure for table `ne13y_ucm_content`
--

DROP TABLE IF EXISTS `ne13y_ucm_content`;
CREATE TABLE IF NOT EXISTS `ne13y_ucm_content` (
...
--
-- Table structure for table `ne13y_updates`
--

DROP TABLE IF EXISTS `ne13y_updates`;
CREATE TABLE IF NOT EXISTS `ne13y_updates` (
...
--
-- Dumping data for table `ne13y_updates`
--

INSERT INTO `ne13y_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Table structure for table `ne13y_update_sites`
--

DROP TABLE IF EXISTS `ne13y_update_sites`;
CREATE TABLE IF NOT EXISTS `ne13y_update_sites` (
...
--
-- Dumping data for table `ne13y_update_sites`
--

INSERT INTO `ne13y_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1370589351),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1370589351),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1370589351);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_update_sites_extensions`
--

DROP TABLE IF EXISTS `ne13y_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `ne13y_update_sites_extensions` (
...
--
-- Dumping data for table `ne13y_update_sites_extensions`
--

INSERT INTO `ne13y_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `ne13y_usergroups`
--

DROP TABLE IF EXISTS `ne13y_usergroups`;
CREATE TABLE IF NOT EXISTS `ne13y_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `ne13y_usergroups`
--

INSERT INTO `ne13y_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `ne13y_users`
--

DROP TABLE IF EXISTS `ne13y_users`;
CREATE TABLE IF NOT EXISTS `ne13y_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `ne13y_users`
--

INSERT INTO `ne13y_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(907, 'Super User', 'admin', 'admin@localhost.com', 'c0ea81636fa2628bd6a805d4cede9dad:juuuMndoI9ujpsQVYJwsEeL71AbrkzZu', 0, 1, '2013-05-28 01:42:34', '2013-06-07 07:15:48', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_user_notes`
--

DROP TABLE IF EXISTS `ne13y_user_notes`;
CREATE TABLE IF NOT EXISTS `ne13y_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ne13y_user_profiles`
--

DROP TABLE IF EXISTS `ne13y_user_profiles`;
CREATE TABLE IF NOT EXISTS `ne13y_user_profiles` (
...
--
-- Table structure for table `ne13y_user_usergroup_map`
--

DROP TABLE IF EXISTS `ne13y_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `ne13y_user_usergroup_map` (
...
--
-- Dumping data for table `ne13y_user_usergroup_map`
--

INSERT INTO `ne13y_user_usergroup_map` (`user_id`, `group_id`) VALUES
(907, 8);

-- --------------------------------------------------------

--
-- Table structure for table `ne13y_viewlevels`
--

DROP TABLE IF EXISTS `ne13y_viewlevels`;
CREATE TABLE IF NOT EXISTS `ne13y_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `ne13y_viewlevels`
--

INSERT INTO `ne13y_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `ne13y_weblinks`
--

DROP TABLE IF EXISTS `ne13y_weblinks`;
CREATE TABLE IF NOT EXISTS `ne13y_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
